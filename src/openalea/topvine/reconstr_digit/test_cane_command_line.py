...
scene2can = function(pm['openalea.grassland.luzerne']['scene2can'])
FileCaribuScene = function(pm['openalea.caribu']['FileCaribuScene'])
addSoil = function(pm['openalea.caribu']['addSoil'])
Caribu = function(pm['openalea.caribu']['Caribu'])
LIE = function(pm['openalea.caribu']['LIE'])
ViewMapOnCan = function(pm['openalea.caribu.visualisation']['ViewMapOnCan'])
selectOutput = function(pm['openalea.caribu']['selectOutput'])
Plot_CaribuScene = function(pm['openalea.caribu.visualisation']['Plot CaribuScene'])
caribu_leaf = function(pm['openalea.topvine.macro']['caribu_leaf'])
read_meteo_H_splitter_encapsulated = function(pm['openalea.topvine.macro']['read_meteo_H_splitter_encapsulated'])
...
#light_file = r'C:\Python26\lib\site-packages\openalea.caribu-6.0.5-py2.6-win32.egg\openalea\caribu_old\data\zenith.light'
...
id_leaves = list(plant_dict.keys())
