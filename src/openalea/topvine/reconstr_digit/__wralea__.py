...
__name__ = 'openalea.topvine.reconstr_digit'
...
visu_digit_visu_digit = Factory(name='visu_digit',
                ...
                nodemodule='openalea.topvine.reconstr_digit.visu_digit',
...
sc_turtle36_compute_optim_angle = Factory(name='compute_optim_angle',
                description='',
                category='Unclassified',
                nodemodule='openalea.topvine.reconstr_digit.sc_turtle36',
...
visu_digit_fromcane_visu_digit_fromcane = Factory(name='visu_digit_fromcane',
                description='',
                category='Unclassified',
                nodemodule='openalea.topvine.reconstr_digit.visu_digit_fromcane',
