...
__name__ = 'openalea.topvine.water_balance'
...
wb_1C_TSW_1C = Factory(name='TSW_1C',
                ...
                nodemodule='openalea.topvine.water_balance.wb_1C',
                nodeclass='TSW_1C',
...
open_meteo_file_open_meteo_wb = Factory(name='open_meteo_wb',
                description='',
                category='Unclassified',
                nodemodule='openalea.topvine.water_balance.open_meteo_file',
...
plot_res_1C_plot_res_1C = Factory(name='plot_res_1C',
                description='',
                category='Unclassified',
                nodemodule='openalea.topvine.water_balance.plot_res_1C',
...
turbid_vine_turbid_vineCyl = Factory(name='turbid_vineCyl',
                description='',
                category='Unclassified',
                nodemodule='openalea.topvine.water_balance.turbid_vine',
