...
__file__="C:\GitModeles\grapevine//topvine\src//openalea//topvine\Radiation2023.py"
...
meteo_horaire = inputs.weather.loc[inputs.weather.index == inputs.weather.index[12]]
